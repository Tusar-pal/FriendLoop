        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form className="space-y-4" onSubmit={handleSaveProfile}>
            ...
            >
              ...
              />
              <div className="relative group/profile w-24 h-24">
                <img
                  src={
            ...
            <div className="">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditFrom({ ...editForm, full_name: e.target.value })
                }
            ...
            <div className="">
              ...
              <input
                type="text"
                className="w-full p-3 border border-gray-200 rounded-lg"
                placeholder="Please ente Username"
                onChange={(e) =>
                  setEditFrom({ ...editForm, username: e.target.value })
                }
            ...
            <div className="">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setEditFrom({ ...editForm, bio: e.target.value })
                }
                value={editForm.bio}
              />
            </div>
            <div className="">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditFrom({ ...editForm, location: e.target.value })
                }
